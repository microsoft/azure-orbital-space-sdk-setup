...
EXTRACT_SETUP_FILES="${EXTRACT_SETUP_FILES:-"true"}"
SMB_ENABLED_IN_CLUSTER="${SMB_ENABLED_IN_CLUSTER:-"false"}"
ADDL_DEBUG_SHIM_SUFFIXES="${ADDL_DEBUG_SHIM_SUFFIXES:-""}"
ADDL_DEBUG_SHIM_SUFFIXES=${ADDL_DEBUG_SHIM_SUFFIXES,,} # Force to lowercase
DEBUG_SHIMS="${APP_NAME}"
AUTO_INJECT_PYTHON_DEV_DEPENDENCIES="${AUTO_INJECT_PYTHON_DEV_DEPENDENCIES:-"false"}"
DEV_LANGUAGE="${DEV_LANGUAGE:-"dotnet"}"
...
export DOTNET_SDK_VERSION=${DOTNET_SDK_VERSION}
...
export SMB_ENABLED_IN_CLUSTER=${SMB_ENABLED_IN_CLUSTER}
export AUTO_INJECT_PYTHON_DEV_DEPENDENCIES=${AUTO_INJECT_PYTHON_DEV_DEPENDENCIES}
export SPACEFX_DIR_FOR_HOST=${SPACEFX_DIR_FOR_HOST}
export SPACESDK_CONTAINER=${SPACESDK_CONTAINER}
export APP_NAME=${APP_NAME}
export APP_TYPE=${APP_TYPE}
export DEV_LANGUAGE=${DEV_LANGUAGE}
